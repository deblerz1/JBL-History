...
export default async function MuseumLayout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="museum-shell museum-home"><header className="museum-nav">
    ...
    <nav aria-label="Museum navigation"><Link href="/museum/seasons">Seasons</Link><Link href="/museum/managers">Managers</Link><Link href="/museum/rivalries">Rivalries</Link><Link href="/museum/drafts">Drafts</Link><Link href="/museum/records">Records</Link></nav>
