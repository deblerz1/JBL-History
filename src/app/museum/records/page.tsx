...
export default async function RecordsPage() {
  ...
  return <main className="exhibit-page"><ExhibitHeader eyebrow="The book of records" title="Extremes & indignities" description="The single-week performances that broke the scale in either direction. Multi-week playoff aggregates are catalogued with their brackets instead of being treated as weekly scores." />
